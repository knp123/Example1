const productData = [{
    ...
    "type": "fruit",
    "description": "Sweet fresh stawberry on the wooden tables2",
    "filename": "8.jpg",
    "height": 600,
    "width": 399,
    "price": 28.59,
...
export function getProductDetails(item) {
    const requiredProduct = productData.find(product => product.description === item.description);
    return Promise.resolve(requiredProduct);
}